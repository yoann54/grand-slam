...
var I18N = {
  ...
  es: {
    sub: 'Hora y tiempo de los 4 torneos de Grand Slam. Tu clave se queda en el teléfono.',
    apiKey: 'Clave API OpenWeatherMap',
    apiPlaceholder: 'pega tu clave',
    getKey: 'Consigue una clave gratis →',
    units: 'Unidad de temperatura',
    celsius: 'Celsius (°C)',
    fahrenheit: 'Fahrenheit (°F)',
    winner: 'Campeón mostrado (última edición)',
    atp: 'ATP (hombres)',
    wta: 'WTA (mujeres)',
    theme: 'Tema',
    dark: 'Oscuro',
  ...
  de: {
    sub: 'Zeit & Wetter der 4 Grand-Slam-Turniere. Dein Schlüssel bleibt auf dem Handy.',
    apiKey: 'OpenWeatherMap API-Schlüssel',
    apiPlaceholder: 'Schlüssel einfügen',
    getKey: 'Kostenlosen Schlüssel holen →',
    units: 'Temperatureinheit',
    celsius: 'Celsius (°C)',
    fahrenheit: 'Fahrenheit (°F)',
    winner: 'Angezeigter Sieger (letzte Ausgabe)',
    atp: 'ATP (Herren)',
    wta: 'WTA (Damen)',
    theme: 'Design',
    dark: 'Dunkel',
  ...
  it: {
    sub: 'Ora e meteo dei 4 tornei del Grande Slam. La tua chiave resta sul telefono.',
    apiKey: 'Chiave API OpenWeatherMap',
    apiPlaceholder: 'incolla la chiave',
    getKey: 'Ottieni una chiave gratis →',
    units: 'Unità di temperatura',
    celsius: 'Celsius (°C)',
    fahrenheit: 'Fahrenheit (°F)',
    winner: 'Campione mostrato (ultima edizione)',
    atp: 'ATP (uomini)',
    wta: 'WTA (donne)',
    theme: 'Tema',
    dark: 'Scuro',
    light: 'Chiaro',
    save: 'Salva',
    support: '☕ Sostieni lo sviluppatore'
  }
};
